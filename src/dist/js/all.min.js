...
!function (e, t) {
  ...
  function $() {
    v.removeEventListener("DOMContentLoaded", $), e.removeEventListener("load", $), b.ready();
  }
  ...
  }), b.ready.then = W.then, "complete" === v.readyState || "loading" !== v.readyState && !v.documentElement.doScroll ? e.setTimeout(b.ready) : (v.addEventListener("DOMContentLoaded", $), e.addEventListener("load", $));
  ...
  function xe(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) {
      if ((o = e[d]) || 0 === o) if ("object" === x(o)) b.merge(p, o.nodeType ? [o] : o);else if (me.test(o)) {
    ...
    for (f.textContent = "", d = 0; o = p[d++];) {
      if (r && b.inArray(o, r) > -1) i && i.push(o);else if (l = re(o), a = ve(f.appendChild(o), "script"), l && ye(a), n) for (c = 0; o = a[c++];) {
  ...
  function Pe(e, t, n) {
    for (var r, i = t ? b.filter(t, e) : e, o = 0; null != (r = i[o]); o++) {
      n || 1 !== r.nodeType || b.cleanData(ve(r)), r.parentNode && (n && re(r) && ye(ve(r, "script")), r.parentNode.removeChild(r));
    }
  ...
  function $e(e, t, n) {
    var r,
        ...
        a,
        s = e.style;
    return (n = n || Me(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || re(e) || (a = b.style(e, t)), !d.pixelBoxStyles() && Re.test(a) && We.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o)), void 0 !== a ? a + "" : a;
  }
  ...
  b.extend({
    ...
    css: function css(e, t, n, r) {
      var i,
          ...
          a,
          s = U(t);
      return Ve.test(t) || (t = Ue(s)), (a = b.cssHooks[t] || b.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = $e(e, t, r)), "normal" === i && t in Ye && (i = Ye[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    }
    ...
    if (t) return (parseFloat($e(e, "marginLeft")) || e.getBoundingClientRect().left - Ie(e, {
      marginLeft: 0
    }, function () {
  ...
  b.extend(b.event, {
    trigger: function trigger(t, n, r, i) {
      ...
      if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !yt.test(m + b.event.triggered) && (m.indexOf(".") > -1 && (x = m.split("."), m = x.shift(), x.sort()), l = m.indexOf(":") < 0 && "on" + m, (t = t[b.expando] ? t : new b.Event(m, "object" == _typeof(t) && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : b.makeArray(n, [t]), p = b.event.special[m] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
        if (!i && !p.noBubble && !g(r)) {
          for (u = p.delegateType || m, yt.test(u + m) || (a = a.parentNode); a; a = a.parentNode) {
            y.push(a), s = a;
          }
        ...
        return t.type = m, i || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(y.pop(), n) || !X(r) || l && h(r[m]) && !g(r) && ((s = r[l]) && (r[l] = null), b.event.triggered = m, t.isPropagationStopped() && d.addEventListener(m, mt), r[m](), t.isPropagationStopped() && d.removeEventListener(m, mt), b.event.triggered = void 0, s && (r[l] = s)), t.result;
      }
    },
  ...
  Rt.href = xt.href, b.extend({
    ...
    ajax: function ajax(t, n) {
      ...
      if (y.promise(E), d.url = ((t || d.url || xt.href) + "").replace(Lt, xt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes = (d.dataType || "*").toLowerCase().match(O) || [""], null == d.crossDomain) {
        u = v.createElement("a");
  ...
  b.ajaxSetup({
    ...
    b.cssHooks[t] = Fe(d.pixelPosition, function (e, n) {
      if (n) return n = $e(e, t), Re.test(n) ? b(e).position()[t] + "px" : n;
    });
  }), b.each({
    Height: "height",
    Width: "width"
